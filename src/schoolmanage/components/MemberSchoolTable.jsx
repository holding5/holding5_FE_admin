...
const columns = [
  ...
  { key: "schoolType", label: "분류", width: "6rem" },
  { key: "province", label: "지역", width: "6rem" },
  { key: "name", label: "학교명", width: "8rem" },
  { key: "phoneNumber", label: "전화", width: "6rem" },
  { key: "address", label: "주소", width: "12rem" },
  { key: "memberCount", label: "회원수", width: "3rem" },
  { key: "pinNumber", label: "핀번호", width: "4rem" },
];
...
export default function MemberSchoolTable({
  // 데이터/상태
  rows = [],
  totalPages = 1,
  page = 1,
