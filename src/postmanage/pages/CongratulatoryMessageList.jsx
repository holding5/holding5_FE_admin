...
import CongratulatoryMessageTable from "../components/CongratulatoryMessageTable";

const CongratulatoryMessageList = () => {
  ...
  return (
    <Box component="section" sx={{ flexGrow: 1, mt: 3 }}>
      ...
      <Box component="section" sx={{ mt: "30px", p: "0px 20px" }}>
        <CongratulatoryMessageTable itemsPerPage={itemsPerPage}/>
      </Box>
    </Box>
  );
};

export default CongratulatoryMessageList;
