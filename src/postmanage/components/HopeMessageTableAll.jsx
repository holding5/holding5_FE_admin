...
const sampleData = [
  ...
  { id: 2, classification: "학폭", isAllow: "거절", inputType: "앱", religion: "불교", title: "제목 1", file: "240809.m4a", date: "2025.01.05", nickName: "추동훈(메뚜기)", reports: 1, comments: 3, lifeSaves: 6, courage: 11, extra: "승인>거절" }
];
...
const columns = [
  ...
  { key: "extra", label: "비고", width: "80px" },

];

const HopeMessageTableAll = ({ itemsPerPage = 10 }) => {
...
export default HopeMessageTableAll;
