...
const sampleData = [
  { id: 1, classification: "공통", isAllow: "거절", religion: "상관없음", title: "그래도 행복을 꿈꿔야합니다.", file: "240808.m4a", date: "2025.01.02", nickName: "유재석(메뚜기)", reports: 0, comments: 3, lifeSaves: 4, courage: 6, notHelpFul: 8, sending: 15, approver: "관리자1" },
  { id: 2, classification: "학폭", isAllow: "보류", religion: "불교", title: "제목 1", file: "240809.m4a", date: "2025.01.05", nickName: "추동훈(메뚜기)", reports: 1, comments: 3, lifeSaves: 6, courage: 11, notHelpFul: 8, sending: 15, approver: "관리자2" }
];
...
const LifeMessageTableRefusal = ({ itemsPerPage = 10 }) => {
...
export default LifeMessageTableRefusal;
