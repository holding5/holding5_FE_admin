...
import { deleteOvercomeComment } from "../hooks/useOvercomePostDetail";
...
const OvercomeComments = ({ comments = [] }) => {
  ...
  const handleCommentDelete = async (commentId) => {
    ...
    try {
      await deleteOvercomeComment(commentId); // DELETE /admin/comments/{commentId}
      alert("댓글이 삭제되었습니다.");
...
export default OvercomeComments;
