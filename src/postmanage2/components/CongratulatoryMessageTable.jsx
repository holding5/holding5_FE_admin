...
import CongratulatoryMessageDetail from "./CongratulatoryMessageDetail";
import { congratulatoryMessageMock } from "../utils/CongratulatoryMessageMock"; // mock 데이터
...
const sortableKeys = [ "classification", "date", "nickName" ];
...
const CongratulatoryMessageTable = ({ itemsPerPage = 10 }) => {
  ...
  // ✅ 필터 적용
  const filteredData = congratulatoryMessageMock.filter((row) => {
