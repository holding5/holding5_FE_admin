...
const pendingCount = lifeMessageMock.filter(
  (msg) => msg.isAllow === "승인완료" || msg.isAllow === "승인대기"
).length;
const rejectingCount = lifeMessageMock.filter(
  (msg) => msg.isAllow === "거절" || msg.isAllow === "승인보류"
).length;
