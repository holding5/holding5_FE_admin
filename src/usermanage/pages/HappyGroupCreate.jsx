...
import GroupCreateInfo from "../../components/GroupCreateInfo";
import GroupCreateDescription from "../../components/GroupCreateDescription";
const filterData = [
  {
    id: "asc",
    text: "가나다 순",
...
const HappyGroupCreate = () => {
  ...
  return (
    <Box component="section" sx={{ flexGrow: 1 }}>
      ...
      <Stack direction="row" spacing={2} sx={{ mt: 2, maxWidth: "950px", mx: "auto" }}>
        <GroupCreateInfo />
...
export default HappyGroupCreate;
