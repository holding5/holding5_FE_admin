...
const DreamUserEvaluation = () => {
  ...
  const header2Style = {
    color: "white",
    fontSize: "1rem",
    backgroundColor: "rgb(209, 103, 23)",
    borderRadius: "3px",
    width: "12rem",
    height: "2.2rem",
    display: "flex",
      ...
      <Box>
          ...
          >
            <FormControl size="small">
              ...
              >
                ...
                <MenuItem value="text">댓글수</MenuItem>
              </Select>
            </FormControl>
          </Box>
        ...
        <Box>
          ...
          <Stack direction="row" gap={2} sx={{ mt: "1rem" }}>
            ...
            <Box sx={header1Style}>
              <Typography>출석수(1년누적)</Typography>
            </Box>
          ...
          <Stack direction="row" gap={2} sx={{ mt: "1rem" }}>
            <Box sx={mainStyle}>
              <Typography>356</Typography>
            </Box>
            <Box sx={mainStyle}>
              <Typography>실버레벨3</Typography>
            </Box>
            <Box sx={mainStyle}>
              <Typography>125</Typography>
            </Box>
          ...
          <Stack direction="row" gap={2} sx={{ mt: "1rem" }}>
            <Box sx={header2Style}>
              <Typography>최초가입일</Typography>
            </Box>

            <Box sx={header2Style}>
              <Typography>총출석일</Typography>
            </Box>
          </Stack>

          <Stack direction="row" gap={2} sx={{ mt: "1rem" }}>
            <Box sx={mainStyle}>
              <Typography>2020.11.22</Typography>
            </Box>
            <Box sx={mainStyle}>
              <Typography>678</Typography>
            </Box>
          </Stack>
        </Box>
      </Box>
